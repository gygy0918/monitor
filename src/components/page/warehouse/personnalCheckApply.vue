<!--<template>-->
    <!--<div class="table">-->
        ...
        <!--<el-table :data="warehouseOut" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">-->
            ...
            <!--&lt;!&ndash;<el-table-column prop="date" label="日期" sortable width="150">&ndash;&gt;-->
            ...
            <!--</el-table-column>-->
            <!--&lt;!&ndash;<el-table-column prop="remark" label="是否出库" width="120">&ndash;&gt;-->
            <!--&lt;!&ndash;</el-table-column>&ndash;&gt;-->
        ...
        <!--<el-dialog title="修改入库申请" :visible.sync="dialogFormVisible">-->
            <!--<el-form :model="form" ref="form">-->
                ...
                <!--&lt;!&ndash;<el-input v-model="form.email" auto-complete="off"></el-input>&ndash;&gt;-->
