    ...
    export default {
        ...
        methods: {
            inital: function () {
                ...
                var _onClickThree = function(e) {
                    if(e.target.subMarkers.length){
                        ...
                        for (var j = 0; j < subMarkersFour.length; j += 1) {
                            ...
                            var html='<li class="detail-list"><p class="img"></p><p class="p">仓库名称：'+title+'</p>' +
                ...
                // console.log('ppppp',window.provinces)
                // var provinces = [{
                //     "id": "1",
                //     "name": "北京市",
